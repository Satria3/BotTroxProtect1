...
satpam.login(token="EqDwDPBRZITDe7TDdI61.xu+pRemObjXCqJHhZX8tqq.O0f7mBKR3LxRmcOfDOOr2BKs/n3a6DGx5/hLC8UfVe4=")
satpam.loginResult()

cl = LINETCR.LINE() #BotTrox1
cl.login(token="Ersq7h8MIFcXseHHBHR2.o8LSrfCelHJhhggYpY3ECG.d9/5/5K0YjWeDkbw71Vra9Wmanurkel6rN5JQbD1vs8=")
cl.loginResult()

ki = LINETCR.LINE() #BotTrox2
ki.login(token="ErUfHlkgeB9kz8feqPe5.hSHvpJH1bE2GB8InsSg0vq.xkZCUduyLxjL8vIBdcYpqFIgWoVqbPQmywXLxNz61Oo=")
ki.loginResult()

kk = LINETCR.LINE() #BotTrox3
kk.login(token="Erw8ZBhI0FDqaIoPIOUd.nI0+pkrzsIaJT928xZbUBq.wAbpmZtKUhf29SaW0CPcgDOGcrEGxu68cc2BNq97mGc=")
kk.loginResult()

kc = LINETCR.LINE() #BotTrix4
kc.login(token="Er91zsytov3izuSCcv5a.VSkC4kWnVqaJsixjMKNE/G.qNwzrmHphWX8ex8o3Vl8rsUY3coqegZ0O74JlGF5+Kk=")
kc.loginResult()
...
ka.login(token="ErF34qVz5ZaBhK3qvSb8.jyCu5B2qelpygXkvspNkYa.EeDQiF8VVD4VcL8La/RTY5Xbm7s6xTz1kBhAFPxrvrA=")
ka.loginResult()

kb = LINETCR.LINE() #BotTrox7
kb.login(token="ErhtnYFVsWbt8obGUmDb.PpTPPNkiz0/ZXpxswLg6EW.cLAv5ELjT5XVrhiXVQOriBzO65dUc6jFfpJWaJdgAXo=")
kb.loginResult()

ko = LINETCR.LINE() #BotTrox8
ko.login(token="EryezcufLvlQkVT9dvza.90Ymb9xHHHXgqdGq7WeeYG.w+GXDN7FD8opDdth23VhY8GG4RnvKvwibjpWqotnGnc=")
ko.loginResult()

ke = LINETCR.LINE() #BotTrox9
ke.login(token="ErhtnYFVsWbt8obGUmDb.PpTPPNkiz0/ZXpxswLg6EW.cLAv5ELjT5XVrhiXVQOriBzO65dUc6jFfpJWaJdgAXo=")
ke.loginResult()

ku = LINETCR.LINE() # BotTrox10
ku.login(token="ErF34qVz5ZaBhK3qvSb8.jyCu5B2qelpygXkvspNkYa.EeDQiF8VVD4VcL8La/RTY5Xbm7s6xTz1kBhAFPxrvrA=")
ku.loginResult()

kl = LINETCR.LINE() #BotTrox11
kl.login(token="EqjlWm3gNFKTFTzG1sE7.hgAoElacI+4QXk31DxNGPW.wujSsr+R0kfUTMuHQid5XqzqmrnZoX/C53KoHNU3Z3g=")
kl.loginResult()

km = LINETCR.LINE() #BotTrox12
km.login(token="EqmauVbDvjiV3G9gHHU5.TCxcnvx1VdTqxQ1T7ry7vq.OWIl9oludwMJYwgFNb2YkpIisKZIR6pxbrCGoUOuDQs=")
km.loginResult()

kn = LINETCR.LINE() #BotTrox13
kn.login(token="EqmauVbDvjiV3G9gHHU5.TCxcnvx1VdTqxQ1T7ry7vq.OWIl9oludwMJYwgFNb2YkpIisKZIR6pxbrCGoUOuDQs=")
kn.loginResult()

kp = LINETCR.LINE() #BotTrox14
kp.login(token="EqmauVbDvjiV3G9gHHU5.TCxcnvx1VdTqxQ1T7ry7vq.OWIl9oludwMJYwgFNb2YkpIisKZIR6pxbrCGoUOuDQs=")
kp.loginResult()

kt = LINETCR.LINE() #BotTrox15
kt.login(token="EqmauVbDvjiV3G9gHHU5.TCxcnvx1VdTqxQ1T7ry7vq.OWIl9oludwMJYwgFNb2YkpIisKZIR6pxbrCGoUOuDQs=")
kt.loginResult()
...
Lmid = kl.getProfile().mid #BotTrox11
Mmid = km.getProfile().mid #BotTrox12
Nmid = kn.getProfile().mid #BotTrox13
Pmid = kp.getProfile().mid #BotTrox14
Tmid = kt.getProfile().mid #BotTrox15
Smid = satpam.getProfile().mid #Akun Utama
mid1 = k1.getProfile().mid #Backup

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,Lmid,Mmid,Nmid,Pmid,Tmid,mid1,"u5d4fcfac4328049c5c423847cf1f1341"]
admin=["u1608ae21e5de2547b5fa8707b21ca220","u622a5e6c9bcec78d243e10e604a32dbd","uf78f7b0be06ce35922a542518bf89f6f","u253f38db954e020c62135c3403fa93f4"] 
    ...
    try:
        ...
        if op.type == 17: #awal 17 ubah 13
           if wait["Protectjoin"] == True:
               if op.param2 not in admin : # Awalnya admin doang
                   random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
        #------Joined User Kick start------#
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            elif "BitTrox4 kick " in msg.text:
              if msg.from_ in admin:
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        kp.findAndAddContactsByMid(target)
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u3bc96c4457042e18c71c61b23f2dde72'}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u1ec8553e387505eda06fc88d4ac1b455'}
                ki.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u362d3f3ca4594a2023b7ddbc5f306e6d'}
                kk.sendMessage(msg)
                msg.contentMetadata = {'mid': 'ubec29ce0ac0dbd00234885c99a49defa'}
                kc.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u030a264c24f957ccf2388bab6fadffe8'}
                ks.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u258714e5bd9010b3d81b129548f9cac8'}
                ka.sendMessage(msg)
                msg.contentMetadata = {'mid': 'ua4fb69a67288674fb3c4f5d25a51ba7b'}
                kb.sendMessage(msg)
                msg.contentMetadata = {'mid': 'uf74c8c07d5e1861c46403810ef0104ca'}
                ko.sendMessage(msg)
                msg.contentMetadata = {'mid':'u3055af21e2197895642bda41ba3e9826'}
                ke.sendMessage(msg)
                msg.contentMetadata = {'mid':'u52788a919dad650d1445511b3ac88120'}
                ku.sendMessage(msg)
                msg.contentMetadata = {'mid':'u1c668e78b0028bfe2ac4adf57579e0a7'}
                kl.sendMessage(msg)
                msg.contentMetadata = {'mid':'ub5c5c23555f5bc3b505ead6ded163b55'}
                km.sendMessage(msg)
                msg.contentMetadata = {'mid':'ub5c5c23555f5bc3b505ead6ded163b55'}
                kn.sendMessage(msg)
                msg.contentMetadata = {'mid':'ub5c5c23555f5bc3b505ead6ded163b55'}
            ...
            elif msg.text in ["BotTrox3 open qr","BotTrox4 buka qr"]:
                if msg.toType == 2:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","BotTrox","Join kuy"]:
              if msg.from_ in owner:
            ...
            elif msg.text in ["BotTrox1 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
              ...
              if msg.from_ in admin:
                  ...
                  cl.updateGroup(X)
                  invsend = 0
                  Ti = kk.reissueGroupTicket(msg.to)
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Kabur all","Keluar all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            klist=[cl,ki,kk,kc,ks,ka,kb,ku,ke,ko,kl,km,kn,kp,kt]
        ...
        #-------------Fungsi Broadcast Start------------#
              ...
              if msg.from_ in owner:
                 ...
                 a = kl.getGroupIdsJoined()
                 a = km.getGroupIdsJoined()
                 a = kn.getGroupIdsJoined()
                 a = kp.getGroupIdsJoined()
                 a = kt.getGroupIdsJoined()
                 ...
                 for taf in a:
                     ...
                     kl.sendText(taf, (bctxt))
                     km.sendText(taf, (bctxt))
                     kn.sendText(taf, (bctxt))
                     kp.sendText(taf, (bctxt))
                     kt.sendText(taf, (bctxt))
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                kl.sendText(msg.to,"BotTrox11 on")
                km.sendText(msg.to,"BotTrox12 on")
                kn.sendText(msg.to,"BotTrox13 on")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐BOTTROX⭐⭐👈")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^BotTrox Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nSatria BotTrox")
                    print "Like"
                except:
                    pass
            else:
    ...
    while True:
        ...
        #while a2():
            ...
            if wait["clock"] == True:
                ...
                profile11 = kl.getProfile()
                profile11.displayName = wait["cName11"]
                ku.updateProfile(profile11)
                
                profile12 = km.getProfile()
                profile12.displayName = wait["cName12"]
                ku.updateProfile(profile12)
                
                profile13 = kn.getProfile()
                profile13.displayName = wait["cName13"]
                ku.updateProfile(profile13)
                
                profile14 = kp.getProfile()
                profile14.displayName = wait["cName14"]
                ku.updateProfile(profile14)
                
                profile15 = kt.getProfile()
                profile15.displayName = wait["cName15"]
                ku.updateProfile(profile15)
                
                profile16 = satpam.getProfile()
                profile16.displayName = wait["cName16"]
                satpam.updateProfile(profile16)
                
                profile17 = k1.getProfile()
                profile17.displayName = wait["cName17"]
                k1.updateProfile(profile14)
            time.sleep(600)
        except:
            pass
