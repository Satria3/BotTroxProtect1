...
satpam.login(token="Erzfhz5mfanSlfOBzDd0.fGIUiExEjuE1/OChSHYIia.d3+Jz2OXEjlzp/4MuhnI3QtlegoQMI4Uxa7qXbPkQS8=")
satpam.loginResult()

cl = LINETCR.LINE() #BotTrox1
cl.login(token="Er4kJjF9lwaAJNSuYIR2.o8LSrfCelHJhhggYpY3ECG.rHYxhCLNLABZP0HluEFTEBEEEbz5eZ7dAp2MV0by5IA=")
cl.loginResult()

ki = LINETCR.LINE() #BotTrox2
ki.login(token="ErIePJfdcRiLn2GLFPO1.xu+pRemObjXCqJHhZX8tqq.eD0La3u53CTIzFzr0KOM+r3f8AxIkxhSD0mpSzsVCSQ=")
ki.loginResult()

kk = LINETCR.LINE() #BotTrox3
kk.login(token="Er4kJjF9lwaAJNSuYIR2.o8LSrfCelHJhhggYpY3ECG.rHYxhCLNLABZP0HluEFTEBEEEbz5eZ7dAp2MV0by5IA=")
kk.loginResult()

kc = LINETCR.LINE() #BotTrix4
kc.login(token="ErY5AIcp43fM4hxcWMza.VSkC4kWnVqaJsixjMKNE/G.Z4Fwbea8MUyt/VqwVOHwsWRnpFhp70x04qW3AI0clBY=")
kc.loginResult()

ks = LINETCR.LINE() #BotTrox5
ks.login(token="ErEFmLtBHdAmGB8s263c.1Ohg/x0KGBZoI68YsjKUNa.AXVG2l/JopR7iUqmTXiio8bw5A6EMPWNTZppMg5CW7E=")
ks.loginResult()

ka = LINETCR.LINE() #BotTrox6
ka.login(token="ErmdHzi3s0RTw790wae8.jyCu5B2qelpygXkvspNkYa.QY2t+e3ylcZyPv3Ndk5fcbF+XKR+T6WuVI2PCVmG1Js=")
ka.loginResult()

kb = LINETCR.LINE() #BotTrox7
kb.login(token="ErBcRixUr8Hxw8V9sGub.PpTPPNkiz0/ZXpxswLg6EW.0K3nKorn1CHprgkbyeL5IHPTjR8QdYkNESlpLeT2EVo=")
kb.loginResult()

ko = LINETCR.LINE() #BotTrox8
ko.login(token="ErbHboy3YfRBE0wV2tha.90Ymb9xHHHXgqdGq7WeeYG./uWiDghLI9+N3Tf+sI73iUvojtfWKhEVE60Uqkgwtr8=")
ko.loginResult()

ke = LINETCR.LINE() #BotTrox9
ke.login(token="ErbHboy3YfRBE0wV2tha.90Ymb9xHHHXgqdGq7WeeYG./uWiDghLI9+N3Tf+sI73iUvojtfWKhEVE60Uqkgwtr8=")
ke.loginResult()

ku = LINETCR.LINE() # BotTrox10
ku.login(token="ErSAz72PsfpQYFEBZUr7.hgAoElacI+4QXk31DxNGPW.MaBkTxZXhXn7XCt5+WiOb9w6nY+LhvRXUzXf5/g7YH0=")
ku.loginResult()

km = LINETCR.LINE() #BotTrox11
km.login(token="ErSAz72PsfpQYFEBZUr7.hgAoElacI+4QXk31DxNGPW.MaBkTxZXhXn7XCt5+WiOb9w6nY+LhvRXUzXf5/g7YH0=")
km.loginResult()
...
k1.login(token="ErIePJfdcRiLn2GLFPO1.xu+pRemObjXCqJHhZX8tqq.eD0La3u53CTIzFzr0KOM+r3f8AxIkxhSD0mpSzsVCSQ=")
k1.loginResult()
...
Jmid = km.getProfile().mid #BotTrox11
Kmid = kn.getProfile().mid #BotTrox12
    ...
    try:
        ...
        if op.type == 11:
          if wait["Protectgr"] == True:
            if random.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots and admin:
                ...
                pass
              	...
              	try:
                	random.sendText(op.param1,random.getContact(op.param2).displayName + "Jangan Buka Kode QR Kk")
                	random.kickoutFromGroup(op.param1,[op.param2])
                	X = random.getGroup(op.param1)
                	X.preventJoinByTicket = True
                	random.updateGroup(X)
                	random.sendText(op.param1,random.getContact(op.param2).displayName + "\n" + "Kami Masukin Kedalam Blacklis Boss")
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,md + datetime.today().strftime('%H:%M:%S'))
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            klist=[cl,ki,kk,kc,ks,ka,kb,ku,ke,ko,km,kn]
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Hello Kk")
                    random.choice(KAC).sendText(msg.to,"BotTrox  Mau Bersih² Group Sampah Nih")
                    random.choice(KAC).sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
              ...
              if msg.from_ in admin:
                if msg.to in wait2['readPoint']:
                    ...
                    try:
                          ...
                          pass
                    wait2['readPoint'][msg.to] = msg.id
                    wait2['readMember'][msg.to] = "Jangan cctv mele sini gabung ka"
                    wait2['setTime'][msg.to] = datetime.now().strftime('%H:%M:%S')
                    wait2['ROM'][msg.to] = {}
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
