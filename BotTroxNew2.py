...
ke.login(token="EryezcufLvlQkVT9dvza.90Ymb9xHHHXgqdGq7WeeYG.w+GXDN7FD8opDdth23VhY8GG4RnvKvwibjpWqotnGnc=")
ke.loginResult()

ku = LINETCR.LINE() # BotTrox10
ku.login(token="EqjlWm3gNFKTFTzG1sE7.hgAoElacI+4QXk31DxNGPW.wujSsr+R0kfUTMuHQid5XqzqmrnZoX/C53KoHNU3Z3g=")
ku.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Smid,mid1,"u1608ae21e5de2547b5fa8707b21ca220"]
